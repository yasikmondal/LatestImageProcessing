...
public class StorageSample{
   ...
   * @return
   */
  public static byte[] resizeImage(byte[] oldImageData, int width, int height) {
		    	      		...
		    	      		System.out.println("$$$$$$$$$$$$$$$$$$$");
		    	      		  Transform rotate = ImagesServiceFactory.makeResize(100, 50);*/
		    	      		   ...
		    	      		   // Make an image directly from a byte array, and transform it.
		    	           		...
		    	           		//byte[] newImagData = resizedImage.getImageData();
		    	           		byte[] newImagData = resizeImage(imageBytes, 125, 75);
		    	      		    
		    	           		System.out.println(newImagData);
		    	      		  
		    	      		    
		    	      		 
		    	      		  	//byte[] imgbyte = resizedImage.getImageData();
		    	      		  
		    	      		// Write the transformed image back to a Cloud Storage object.
		    	        	    gcsService.createOrReplace(
		    	        	        new GcsFilename(bucketName, "resizedImage_125X75" + object.getName()+".jpeg"),
		    	        	        new GcsFileOptions.Builder().mimeType("image/jpeg").build(),
		    	        	        ByteBuffer.wrap(newImagData));
